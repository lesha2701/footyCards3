...
const SECTIONS = [
  ...
  },
  {
    icon: "🎯",
    title: "Выбор карты",
    text: "Зная фазу, выбери одну карту из ещё не сыгранных. В атакующей фазе сравнивается АТК, в оборонительной — ЗЩТ. Карта нападающего (LW/ST/RW) получает +15% к АТК в атакующей фазе, карта защитника или вратаря — +15% к ЗЩТ в оборонительной. У полузащитников бонуса нет ни в одной из фаз — их сила в сбалансированных характеристиках.",
  },
  {
    icon: "🏆",
    title: "Победа в раунде",
    text: "Выигрывает раунд тот, у кого выше итоговый показатель с учётом бонуса. Если значения совпали — раунд считается ничьей, очко не получает никто.",
  },
  {
    icon: "📊",
    title: "Итог матча",
  ...
  },
  {
    icon: "🤖",
    title: "Против бота",
    text: "Матч играется вживую, раунд за раундом, в одну сессию. Сложность влияет на силу состава бота и на то, насколько разумно он выбирает карты. За победу, ничью и поражение начисляются монеты и меняется рейтинг Тактико.",
  },
  {
    icon: "🧑‍🤝‍🧑",
    title: "Против друга",
    text: "Вызови друга через поиск — он должен принять вызов. Дальше каждый выбирает карту для раунда в своё время: выбор соперника скрыт, пока не походят оба. Монеты за такие матчи не начисляются — только рейтинг, чтобы нельзя было договориться и накручивать монеты.",
  },
  {
    icon: "⏳",
