...
import type { ClubMissingItemClaimResult, ClubMissingItemReveal, ClubMissingItemStart } from "@/types";
...
export default function ClubMissingItemPage() {
  ...
  const [claimResult, setClaimResult] = useState<ClubMissingItemClaimResult | null>(null);
