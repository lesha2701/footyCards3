  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-xs text-ink-mist">
        Клубные игры и ежедневная награда клуба за последние {ACTIVITY_WINDOW_DAYS} дней (без обычных мини-игр
        и личной ежедневной награды). Список ниже отсортирован от самых неактивных к самым активным.
      </p>
