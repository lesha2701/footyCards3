...
export interface GameConfig {
  ...
  club_games_hourly_limit: number;
  ...
  club_position_match_daily_reward_limit: number;
  club_position_match_max_mistakes: number;
