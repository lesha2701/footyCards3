    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="mt-1 text-xs text-slate-400">
          Коллективный еженедельный ивент: все игроки вместе выполняют задания. Изменение цели активного задания
          применяется сразу — в том числе на уже идущую неделю. Добавление нового задания или включение/выключение
          существующего применяется только со следующей недели.
        </p>
        {!state?.is_enabled && (
